...
def get_routes() -> dict[tuple[str, str], InspectRoute]:
    ...
    from mxm.moneymachine.marketdata.inspect.statistics_1d.instrument import (
        inspect_statistics_1d_instrument,
    )
    from mxm.moneymachine.marketdata.inspect.statistics_1d.product import (
        get_product_attempts_report,
    )
    from mxm.moneymachine.marketdata.inspect.statistics_1d.system import (
